export const API_BASE = import.meta.env.VITE_API_BASE || "https://smm-admin-panel-back-production.up.railway.app";
...
export const api = {
  ...
  recalcBonus: () => request("/api/bonuses/recalculate", { method: "POST" })
};
